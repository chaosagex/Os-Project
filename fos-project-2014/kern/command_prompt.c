...
struct Command commands[] = 
{
		...
		{ "run", "runs a user program", command_run_program },
		{"load", "", commnad_load_env},
		{"runall", "", command_run_all},
		{"printall", "", command_print_all},
		//{"killall", "", command_kill_all},
		{"lru", "", command_set_page_rep_LRU},
		{"fifo", "", command_set_page_rep_FIFO},
		{"clock", "", command_set_page_rep_CLOCK},
